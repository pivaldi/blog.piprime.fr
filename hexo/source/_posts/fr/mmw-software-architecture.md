...
L'objectif de ce document est de présenter **un cadre d'architecture logicielle à la fois modulaire et rigoureux avec des outils d'automatisation et de vérification solides ainsi que des briques logicielles (plus spécialisées que des librairies) réutilisables pour tous les projets tout en garantissant un environnement de développement qui reste simple et automatisé.**

Ce cadre est implémenté dans [A proof-of-concept of the Go Modular Monolith White Paper](https://github.com/pivaldi/mmw-poc) et a donné lieu à [Platform library and developer tooling for the MMW-Modular Monolith Workspace](https://github.com/piprim/mmw) tous deux basés sur le white-paper [Go Modular Monolith Workspace with Pure Contract Definitions](https://github.com/pivaldi/go-modular-monolith-white-paper).
