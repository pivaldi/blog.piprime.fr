...
This article is available in [english](/en/repricing-the-economy-in-bitcoin).

Vous trouverez ci-dessous un **résumé structuré** du document **“[Repricing the Economy in Bitcoin](https://www.unchained.com/go/repricing-the-economy-in-bitcoin)”**.  
Une vidéo en français à ce sujet est également [disponible sur YouTube](https://youtu.be/VDwrXAdZmAY?si=blog.piprime.fr).
...
Au lieu de se demander *« Combien vaut le bitcoin en dollars ? »*, les auteurs proposent d’inverser la question :
**« Combien valent tous les autres actifs en bitcoin ? »**
...
```
Taux d’actualisation = taux sans risque + prime de risque actions
```

En BTC :

```
Taux d’actualisation = rendement attendu du bitcoin – prime de stabilité des actions
```
